...
public class IDGeneratorEso extends ExecuteSQLObject{
    ...
    public String generateBuildtimeId() throws Exception {
        ...
        // get current id from repository;
        Object rid = jdbcTemplate.queryForObject("select BuildtimeCode from idcache", new RowMapper<Object>() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return rs.getString(1);
            }
        });
    ...
    public String generateBuildtimeSerialCode() throws Exception {
        ...
        // get current id from repository;
        Object rid = jdbcTemplate.queryForObject("select SerialCode from idcache", new RowMapper<Object>() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return rs.getString(1);
            }
        });
    ...
    public String[] generateCodes(int count) throws Exception {
        ...
        Object code = jdbcTemplate.queryForObject("select SerialCode from idcache", new RowMapper<Object>() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return rs.getString(1);
            }
        });
    ...
    public String generateNewVersionNo() throws Exception {
        ...
        Object ver = jdbcTemplate.queryForObject("select VersionNumber from idcache", new RowMapper<Object>() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return rs.getInt(1);
            }
        });
    ...
    public String generateBuildtimeUniCounting() throws Exception {
        ...
        // get current version from repository;
        Object ver = jdbcTemplate.queryForObject("select UniCounting from idcache", new RowMapper<Object>() {
            public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
                return rs.getInt(1);
            }
        });
