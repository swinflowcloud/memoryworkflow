...
public class RuntimeWorkflowController {
	...
	@RequestMapping(value = "/api1", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public String pause() {
		try {
	...
	@RequestMapping(value = "/api2", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public String stop() {
		try {
	...
	@RequestMapping(value = "/api3", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	 ...
	 * @return String
	 */
	@RequestMapping(value = "/api5", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public Object launchProcessInstance(String pid, String userid, String ipv4, String ipv6, String longitude,
			String latitude, String device, String paramvalues, String fullname) {
		try {
			...
			WfProcessInstance inst = SaaSServer.getInstance().launch(pid, userid, ipv4, ipv6, longitude, latitude,
					device, savelist);
			if (inst != null) {
				if (inst.getWorkflowType() != 0) {
					WorkitemInfoDescriptor r = getCurrWorkItemforSWf(inst, null, userid, ipv4, fullname);
					if (r != null) {
						return r;
					} else {
						return "{\"status\": \"1\"}"; //
	...
	@ResponseBody
	public AdminSearchResult[] adminSearch(String oid, String cond1, String cond2, String cond3, String cond4) {
		try {
	...
	@ResponseBody
	public WorkitemInfoDescriptor[] fetchManualTaskInstancesforMWf(String uid, String fullname, String staffids,
			String cond, String qtype) {
		try {
	...
	@ResponseBody
	public WorkitemInfoDescriptor fetchManualTaskInstanceforMWf(String pid, String tid, String userid, String userip,
			int priority, String fullname) {
		try {
	...
	@RequestMapping(value = "/api10", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public Object sendCommandWithSaving(String cmd, String pid, String tid, String userid, String userip, String list,
			String newuserid, String fullname) {
		String success = "0";
		try {
	...
	/**
	 * 这个方法的设计思想对于单参与者的流程执行以及性能非常重要，现在的设计我任务不是最好的， 因此，需要好好思考并优化这个设计。曹大海注于2018-03-20
	 *
	 ...
	 * @throws Exception
	 */
	private WorkitemInfoDescriptor getCurrWorkItemforSWf(WfProcessInstance inst, String tid, String userid, String ipv4,
	...
	@RequestMapping(value = "/api11", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public String sendCommandWithoutSaving(String cmd, String pid, String tid, String userid, String fullname,
	...
	@ResponseBody
	public AdminSearchResult[] adminApplcationSearch(String pid, String cond1, String cond2, String cond3,
			String cond4) {
		try {
	...
	@RequestMapping(value = "/api13", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public String addNewComment(String pid, String tid, String comment) {
		try {
			Comment cmt = WfProcessInstanceJSONParser.parseComment(new JSONObject(comment));
			return SaaSServer.getInstance().addComment(pid, tid, cmt);
		} catch (Exception e) {
			e.printStackTrace();
			return null; // failed
		}
	...
	@RequestMapping(value = "/api14", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public String addChatMessage(String pid, String tid, String message) {
		try {
			ChatMessage msg = WfProcessInstanceJSONParser.parseChatMessage(new JSONObject(message));
			return SaaSServer.getInstance().addChatMessage(pid, tid, msg);
		} catch (Exception e) {
			e.printStackTrace();
			return null; // failed
		}
	...
	@RequestMapping(value = "/api15", method = RequestMethod.POST, headers = "Accept=application/json", produces = "application/json; charset=utf-8")
	@ResponseBody
	public String addInvitation(String pid, String tid, String invitation) {
		try {
			return SaaSServer.getInstance().addInvitation(pid, tid, invitation);
		} catch (Exception e) {
			e.printStackTrace();
			return null; // failed
		}
