...
(function($, window, document, undefined) {
	...
	ManualTaskEditPanel.prototype.loadPane = function(entity, tabindex, owner) {
		...
		if (owner.workflowType == 2) {
			...
			this.participantSettingPane = plugin4
					.data("participantSettingPane");
			...
			if (entity instanceof ManualTaskInstance) {
				...
				this.candidateSettingPane = plugin5
						.data("candidateSettingPane");
			}
		}

		$(
				'#manualtask-props-nav-tabs a[href="#mtptab'
						+ this.currtabindex + '"]').tab('show');
		if (this.currtabindex == 0 || this.currtabindex == 3) {
			if (owner instanceof WfProcess) {
