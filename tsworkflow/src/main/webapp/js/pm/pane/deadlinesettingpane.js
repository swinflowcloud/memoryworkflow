...
(function($, window, document, undefined) {
	...
	DeadlineSettingPanel.prototype.init = function(options) {
		...
		//dllabel.className = "sr-only";
		dllabel.setAttribute("for", "deadline" + options.id);
		dllabel.innerHTML = "办结期限"+"&nbsp;&nbsp;";
		
		
		var dlinputDiv = document.createElement("DIV");
		dldiv.appendChild(dlinputDiv);
		dlinputDiv.className = "input-group";
		
		this.dlinput = document.createElement("select");
		dlinputDiv.appendChild(this.dlinput);
		this.dlinput.className = "form-control";
		this.dlinput.id = "deadline" + options.id;
		
		var dllabel1 = document.createElement("DIV");
		dlinputDiv.appendChild(dllabel1);
		dllabel1.className = "input-group-addon";
		dllabel1.innerHTML = "天";
		
		this.addOptions(this.dlinput, "0", "0", 0);
		this.addOptions(this.dlinput, "1", "1", 1);
		this.addOptions(this.dlinput, "2", "2", 2);
		this.addOptions(this.dlinput, "3", "3", 3);
		this.addOptions(this.dlinput, "5", "5", 4);
		this.addOptions(this.dlinput, "7", "7", 5);
		this.addOptions(this.dlinput, "10", "10", 6);
		this.addOptions(this.dlinput, "15", "15", 7);
		this.addOptions(this.dlinput, "20", "20", 8);
		this.addOptions(this.dlinput, "30", "30", 9);
		this.addOptions(this.dlinput, "60", "60", 10);
		
		this.dlinput.addEventListener("change", this, false);
