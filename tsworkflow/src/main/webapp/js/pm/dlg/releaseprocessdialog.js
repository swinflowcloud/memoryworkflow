			...
			if (selected.length > 0) {
				...
				if (arry[0] == "0" || arry[0] == "3") {
					...
					$.post(service.api(10), {
						...
						version : ver,
						versionnote : this.verNote.value,
						releaser : this.releaser.value,
						releaserid : this.options.uid,
						purchaseprice : this.purchasePriceInput.value,
						usageprice : this.usagePriceInput.value,
						parent : parentfolder.id, // parent folder ID
